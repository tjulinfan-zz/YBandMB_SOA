...
public class UserRESTClient {
    ...
    public UserRESTClient() {
        ...
        webTarget = client.target(BASE_URI).path("com.potatoni.entity.user");
    }
    ...
    public <T> T findByUsername_JSON(Class<T> responseType, String username) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("username/{0}", new Object[]{username}));

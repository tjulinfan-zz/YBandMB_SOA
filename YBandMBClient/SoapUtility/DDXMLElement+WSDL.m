...
//    return [self GetChildNodeByNodeName:@"schema" ParentNode:self];
//}
...
-(NSArray *)Types_Schema_Elements{
    return [self GetChildrenNodeByNodeName:@"element" ParentNode:self];
}

-(NSArray *)Types_Schema_ComplexType{
    return [self GetChildrenNodeByNodeName:@"complexType" ParentNode:self];
}

//definitions->types->schema->element name="***"
-(DDXMLElement *)Get_Types_Schema_Element_ByMethodName:(NSString *)methodName{
    NSArray *children =[self Types_Schema_ComplexType];
